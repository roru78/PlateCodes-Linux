...
UBUNTU_TRANSLATION_DOMAIN="platecodes.arc676"
...
aptest.commands = bash $$PWD/PlateCodes/tests/autopilot/run
aptest.depends  = sub-PlateCodes

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/PlateCodes/tests/unit 
unittest.depends  = sub-PlateCodes
